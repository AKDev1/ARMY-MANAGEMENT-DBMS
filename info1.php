...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
                ...
                <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                  ...
                  <div class="panel panel-skin">
                    <div class="panel-heading">
                      <h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Soldier Registration <small></small></h3>
                    </div>
                    <div class="panel-body">
                      <div id="sendmessage">Your message has been sent. Thank you!</div>
                      <div id="errormessage"></div>

                      <form action="" method="post" role="form" class="contactForm lead" style="margin-top:400px;">
                        <div class="row">
      ...
      <section id="boxes" class="home-section paddingtop-80" style="margin-top:100px;">
            ...
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <i class="fa fa-check fa-3x circled bg-skin"></i>
                  <h4 class="h-bold" ><a name="make" href="make.php">Make an appoinment</a></h4>
                <p>
            ...
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <i class="fa fa-list-alt fa-3x circled bg-skin"></i>
                  <h4 class="h-bold"><a name="make" href="make.php">Choose your package</a></h4>
                <p>
                  Lorem ipsum dolor sit amet, nec te mollis utroque honestatis, ut utamur molestiae vix, graecis eligendi ne.
                </p>
              </div>
            ...
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                <i class="fa fa-user-md fa-3x circled bg-skin"></i>
                  <h4 class="h-bold"><a name="make" href="make.php">Help by specialist</a></h4>
                <p>
                  Lorem ipsum dolor sit amet, nec te mollis utroque honestatis, ut utamur molestiae vix, graecis eligendi ne.
                </p>
              </div>
            ...
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <i class="fa fa-hospital-o fa-3x circled bg-skin"></i>
                  <h4 class="h-bold"><a name="make" href="make.php">Get diagnostic report</a></h4>
                <p>
                  Lorem ipsum dolor sit amet, nec te mollis utroque honestatis, ut utamur molestiae vix, graecis eligendi ne.
                </p>
              </div>
